...
class TestRevokeResponse:
    ...
    def test_revoke_returns_204(
        self, anonymous_client, mock_auth_service, revoke_payload
    ):
    ...
    def test_revoke_returns_422_for_missing_field(
        self, anonymous_client, mock_auth_service
    ):
...
class TestGetCurrentUserDependency:
    ...
    def test_invalid_token_returns_401(self, anonymous_client, mock_auth_service):
